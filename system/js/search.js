(function ($) {
  ...
  function runTerminal(a) {
    ...
    $(input)
      ...
      e.which === 93) {
            ...
            else if(isMath(filter)){
              // alert("is math");
              mathResult = math.eval(filter);
							var resultElement = $("<div class='ui-listview-item math-result'><b>= </b><span>"+mathResult+"</span>");
              $(list).append(resultElement);
            }
            else {
  ...
  // On DOM ready
    ...
    $('.ui-search-icon').click(function(){$('input').show().focus();})
	});
}) (jQuery);
